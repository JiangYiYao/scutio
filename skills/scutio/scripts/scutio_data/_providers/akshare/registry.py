...
ADAPTERS = {
    ...
    "stock_balance_sheet_by_yearly_em": Adapter("eastmoney", "financial_statements_a"),
    ...
    "stock_cash_flow_sheet_by_yearly_em": Adapter("eastmoney", "financial_statements_a"),
    ...
    "stock_info_bj_name_code": Adapter("bse", "stock_info_bj_name_code", True),
    "stock_info_global_cls": Adapter("cls", "stock_info_global_cls"),
    "stock_info_global_em": Adapter("eastmoney", "stock_info_global_em"),
    "stock_info_sh_name_code": Adapter("sse", "stock_info_sh_name_code"),
    "stock_info_sz_name_code": Adapter("szse", "stock_info_sz_name_code"),
    ...
    "stock_profit_sheet_by_yearly_em": Adapter("eastmoney", "financial_statements_a"),
    ...
    "stock_yjbb_em": Adapter("eastmoney", "stock_yjbb_em", True),
